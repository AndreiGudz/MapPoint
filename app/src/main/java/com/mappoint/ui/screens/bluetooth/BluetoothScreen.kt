...
fun BluetoothScreen(
    ...
    onNavigateBack: () -> Unit,
    onGpsDataReceived: (Double, Double, String?, String?) -> Unit
) {
    ...
    Scaffold(
        modifier = Modifier.testTag("BluetoothScreen"),
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(
                        ...
                        modifier = Modifier.testTag("BluetoothBackButton")
                    ) {
            ...
            if (uiState.hasPermissions) {
                ...
                PrimaryTabRow(selectedTabIndex = selectedTab) {
                    Tab(
                        ...
                        modifier = Modifier.testTag("DevicesTabButton"),
                    ...
                    Tab(
                        ...
                        modifier = Modifier.testTag("ChatTabButton"),
                ...
                when (selectedTab) {
                    ...
                    1 -> ChatTab(
                        ...
                        onRequestGps = { bluetoothViewModel.requestGpsFromDevice() },
